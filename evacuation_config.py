...
class AgentConfig:
    ...
    # Population settings
    num_people: int = 200
    family_ratio: float = 0.25
    cyclist_ratio: float = 0.15  # 15% cyclists
    fisherman_ratio: float = 0.05
    construction_worker_ratio: float = 0.10
    ...
    # Terrain behaviour
    terrain_speed_modifiers: Dict[str, float] = field(default_factory=lambda: {
        'dark_green': 1.2,
        'brown': 1.15,
        'sand': 0.9,
        'red': 1.1,
    ...
    terrain_walkable_roles: Dict[str, List[str]] = field(default_factory=lambda: {
        'brown': ['pedestrian', 'runner', 'family', 'cyclist', 'fisherman'],
        'red': ['pedestrian', 'runner', 'family', 'cyclist', 'fisherman', 'construction_worker'],
        'sand': ['pedestrian', 'runner', 'family', 'fisherman', 'cyclist'],
        'dark_green': ['pedestrian', 'runner', 'family', 'cyclist', 'fisherman', 'construction_worker'],
        'black': ['construction_worker']
    })

    # Specialized populations
    family_group_size: int = 4
    family_speed_multiplier: float = 0.75
    runner_speed_multiplier: float = 1.35
    runner_share_of_normal: float = 0.2
...
class HazardConfig:
    ...
    hazard_safe_distance: float = 150.0  # Distance to consider safe from hazard (legacy)
    ...
    gaussian_peak_intensity: float = 1.0
    gaussian_sigma_along: float = 120.0
    gaussian_sigma_cross: float = 60.0
    gaussian_sigma_growth_along: float = 1.5
    gaussian_sigma_growth_cross: float = 0.9
    gaussian_decay_rate: float = 0.01
    gaussian_intensity_threshold: float = 0.08
...
class SimulationConfig:
    ...
    hazard_retarget_interval: int = 5
    crowding_update_interval: int = 3
    path_cache_ttl: int = 20
    path_cache_prune_threshold: int = 2500
    graph_sampling_rate: int = 4
